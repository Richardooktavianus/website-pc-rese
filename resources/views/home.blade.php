...
.banner-slide {
  ...
  position: relative;
  overflow: hidden;
  /* Aspect ratio responsif: 16:5 desktop, 16:7 hp */
  aspect-ratio: 16 / 5;
}
...
.dot.active {
  ...
  .brand-item[data-brand="NVIDIA"]:hover .brand-name {
    color: #76b900;
    text-shadow: 0 0 12px rgba(118, 185, 0, 0.5);
  }

  .brand-item[data-brand="INTEL"]:hover .brand-name {
    color: #0071c5;
    text-shadow: 0 0 12px rgba(0, 113, 197, 0.5);
  }

  .brand-item[data-brand="ASUS"]:hover .brand-name {
    color: #1a9bd7;
    text-shadow: 0 0 12px rgba(26, 155, 215, 0.5);
  }

  .brand-item[data-brand="MSI"]:hover .brand-name {
    color: #e31e24;
    text-shadow: 0 0 12px rgba(227, 30, 36, 0.5);
  }

  .brand-item[data-brand="CORSAIR"]:hover .brand-name {
    color: #ffd700;
    text-shadow: 0 0 12px rgba(255, 215, 0, 0.5);
  }

  .brand-item[data-brand="AMD"]:hover .brand-name {
    color: #ed1c24;
    text-shadow: 0 0 12px rgba(237, 28, 36, 0.5);
  }

  .brand-item[data-brand="GIGABYTE"]:hover .brand-name {
    color: #e7792b;
    text-shadow: 0 0 12px rgba(231, 121, 43, 0.5);
  }
...
<div class="banner-wrap">
  <div class="banner-track" id="bannerTrack">
    ...
    <div class="banner-slide">
      <img src="{{ asset('images/banner/banner1.png') }}" class="banner-img">
      <div class="banner-overlay"></div>
    </div>

    {{-- Slide 2 --}}
    <div class="banner-slide">
      <img src="{{ asset('images/banner/banner2.png') }}" class="banner-img">
      <div class="banner-overlay"></div>
    </div>

    {{-- Slide 3 --}}
    <div class="banner-slide">
      <img src="{{ asset('images/banner/banner3.png') }}" class="banner-img">
      <div class="banner-overlay"></div>
    </div>

    {{-- Slide 4 --}}
    <div class="banner-slide">
      <img src="{{ asset('images/banner/banner4.png') }}" class="banner-img">
      <div class="banner-overlay"></div>
    </div>

    {{-- Slide 5 --}}
    <div class="banner-slide">
      <img src="{{ asset('images/banner/banner5.png') }}" class="banner-img">
      <div class="banner-overlay"></div>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const total = slides.length; // otomatis ambil jumlah slide
    ...
    document.querySelector('.banner-btn.prev')
      .addEventListener('click', () => goSlide((current - 1 + total) % total));

    document.querySelector('.banner-btn.next')
      .addEventListener('click', () => goSlide((current + 1) % total));
    ...
    function initProductGrid() {
      ...
      allCards.forEach((card, i) => {
        card.style.display = i < visibleUntil ? '' : 'none';
      });
